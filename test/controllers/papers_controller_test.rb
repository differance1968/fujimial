...
class PapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post papers_url, params: { paper: { file: @paper.file, grade_id: @paper.grade_id, picture: @paper.picture, subject_id: @paper.subject_id, title: @paper.title } }
    end
  ...
  test "should update paper" do
    patch paper_url(@paper), params: { paper: { file: @paper.file, grade_id: @paper.grade_id, picture: @paper.picture, subject_id: @paper.subject_id, title: @paper.title } }
